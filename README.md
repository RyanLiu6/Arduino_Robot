...
3. Moves around the room "smartly"
    <-> Current thoughts: Move through a room once using object detection </->
    <-> Want to also save an image of the ceiling for each room and after one run,
    and will be able to differentiate between rooms and apply previous movements </->
    <-> Be able to recognize where is a cliff, and stop before falling off </->
